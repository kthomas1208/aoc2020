import { day4, day4_2 } from "./index.ts";
...
/** PART 1 --------------------------------------------*/
test("1.1 - should return count of valid passports", () => {
  let result = day4(testInput.split('\n\n'));
  expect(result).toBe(2);
});

test("1.2 - should return count of valid passports", () => {
  let result = day4(finalInput.split('\n\n'));
  expect(result).toBe(228);
});

/** PART 2 --------------------------------------------*/
test("2.1 - should return count of valid passports", () => {
  let result = day4_2(testInput2.split('\n\n'));
  expect(result).toBe(4);
});

test("2.2 - should return count of valid passports", () => {
  let result = day4_2(finalInput.split('\n\n'));
