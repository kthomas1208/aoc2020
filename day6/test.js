import { day6, day6_2 } from "./index.ts";
...
/** PART 1 --------------------------------------------*/
test("1.1 - should return sum of counts", () => {
  let result = day6(testInput.split('\n\n'));
  expect(result).toBe(11);
});

test("1.2 - should return sum of counts", () => {
  let result = day6(finalInput.split('\n\n'));
  expect(result).toBe(6911);
});

/** PART 2 --------------------------------------------*/
test("2.1 - should return sum of counts", () => {
  let result = day6_2(testInput.split('\n\n'));
