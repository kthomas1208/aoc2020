import { day7, day7_2 } from "./index.ts";
...
/** PART 1 --------------------------------------------*/
test("1.1 - should return bag count", () => {
  let result = day7(testInput.split('\n'));
  expect(result).toBe(4);
});

test("1.2 - should return bag count", () => {
  let result = day7(finalInput.split('\n'));
  expect(result).toBe(355);
});

/** PART 2 --------------------------------------------*/
test("2.1 - should return total bags", () => {
  let result = day7_2(testInput2.split('\n'));
  expect(result).toBe(126);
});

test("2.2 - should return total bags", () => {
  let result = day7_2(testInput.split('\n'));
  expect(result).toBe(32);
});

test("2.3 - should return total bags", () => {
  let result = day7_2(finalInput.split('\n'));
  expect(result).toBe(5312);
});