...
const smallTestInput = `R8,U5,L5,D3
U7,R6,D4,L4`;

const mediumTestInput = `R75,D30,R83,U83,L12,D49,R71,U7,L72
U62,R66,U55,R34,D71,R55,D58,R83`;

const largeTestInput = `R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51
U98,R91,D20,R16,D67,R40,U7,R15,U6,R7`;

/** PART 1 */
test('part 1 - test 1', () => {
  let input = smallTestInput.split('\n');
  expect(processor(input[0], input[1])).toEqual(6);
});

test('part 1 - test 2', () => {
  let input = mediumTestInput.split('\n');
  expect(processor(input[0], input[1])).toEqual(159);
});

test('part 1 - test 3', () => {
  let input = largeTestInput.split('\n');
  expect(processor(input[0], input[1])).toEqual(135);
});

// FINAL TEST
test('part 1 - final test', () => {
  let input = finalTestInput.split('\n');
  expect(processor(input[0], input[1])).toEqual(1195);
});

/** PART 2 --------------------------------------------*/
test('part 2 - test 1', () => {
  let input = smallTestInput.split('\n');
  expect(processor2(input[0], input[1])).toEqual(30);
});

test('part 2 - test 2', () => {
  let input = mediumTestInput.split('\n');
  expect(processor2(input[0], input[1])).toEqual(610);
});

test('part 2 - test 3', () => {
  let input = largeTestInput.split('\n');
  expect(processor2(input[0], input[1])).toEqual(410);
});

// FINAL TEST
test('part 2 - final test', () => {
  let input = finalTestInput.split('\n');
  expect(processor2(input[0], input[1])).toEqual(410); // 129324
});
