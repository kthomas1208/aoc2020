import { day11, day11_2 } from "./index.ts";
...
test("1.1 - should return value", () => {
  let result = day11(testInput.split('\n'));
  expect(result).toBe(37);
});

test("1.2 - should return value", () => {
  let result = day11(finalInput.split('\n'));
  expect(result).toBe(2164);
});

/** PART 2 --------------------------------------------*/
test("2.1 - should return value", () => {
  let result = day11_2(testInput.split('\n'));
  expect(result).toBe(26);
});

test("2.2 - should return value", () => {
  let result = day11_2(finalInput.split('\n'));
