import { day2, day2_2 } from "./index.ts";

const finalInput = `4-7 z: zzzfzlzzz
3-4 l: blllk
8-11 j: jjjjjjjgjjjj
6-7 l: lllhlbl
...
/** PART 1 --------------------------------------------*/
test("1.1 - should return count", () => {
  let result = day2(testInput.split('\n'));
  expect(result).toBe(2);
});

test("1.2 - should return count", () => {
  let result = day2(finalInput.split('\n'));
  expect(result).toBe(396);
});

/** PART 2 --------------------------------------------*/
test("2.1 - should return count", () => {
  let result = day2_2(testInput.split('\n'));
  expect(result).toBe(1);
});

test("2.2 - should return count", () => {
  let result = day2_2(finalInput.split('\n'));
